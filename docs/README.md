...
Guides live under [`guides/`](guides/), starting with [development.md](guides/development.md) on installing, building and testing the monorepo. [authentication.md](guides/authentication.md) covers signing in; [staff-and-roles.md](guides/staff-and-roles.md) covers who may do what once signed in; [ticketing-settings.md](guides/ticketing-settings.md) covers departments, teams and a brand's ticketing settings; [realtime.md](guides/realtime.md) covers the WebSocket gateway, rooms and presence; [tickets.md](guides/tickets.md) covers the ticket model, its thread and its API; [contacts.md](guides/contacts.md) covers who a person is, how Helpdock recognises them again and what erasing one does; [release.md](guides/release.md) covers changesets, tags, GHCR and the SBOM. Configuration, channel and API guides are added as the features they describe ship.
