...
| `/admin/ticketing/<other>` | `Admin/Ticketing` | Routed placeholders that name the deliverable filling them: Statuses and Priorities with M1-02, Views with M1-05, Tags, Custom fields and Templates with M1-06, Assignment with M1-07. |

Reordering has two ways in and one path out. The drag handle is a real button —
...
`src/ticketing/api.ts`. Its DTOs are Zod
