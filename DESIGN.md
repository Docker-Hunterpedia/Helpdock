...
| 2026-09-24 | 1.5. Added MergedThread to §6.3 for merge and split (M1-09). It is built from the Banner, the hairline caption of the system event and the `bg.canvas` card, so it adds no token. |
