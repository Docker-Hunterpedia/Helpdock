...
**Custom fields** and **Templates** (M1-06), and **Assignment** (M1-07). The
other two exist so the row is whole and each says which deliverable fills it:
Priorities with M1-02, Views with M1-05.
...
Ten tenant tables, all under a `FORCE`d row-level security policy on
