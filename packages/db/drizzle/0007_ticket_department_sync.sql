-- What `0006_tickets.sql` cannot express in the Drizzle schema: the trigram
-- index the ticket list's fuzzy subject search needs, and the two triggers that
-- keep the denormalised `department_id` on a ticket's children true.
--
